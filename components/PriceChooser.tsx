         ...
         {() => (
            <div id='price-chooser' className={`modal ${errorDetected}`}>
               ...
               <div className='content'>
                  ...
                  <p>Please note that <strong>this contract will deduct a {royaltyRate}% royalty</strong> from the proceeds when your token sells.  At the price below, a sale of this token will net you <strong>{Math.round((newPrice * (100 - royaltyRate) / 100) * 10000) / 10000} eth</strong>.</p>
